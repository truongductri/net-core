...
namespace OmegaProject.Controllers
{
    public class StatusController : Controller
    {
        ...
        public StatusController(OmegaProjectContext context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Create([Bind("StatusId,StatusName,StatusNotes,StatusDisabled,TableName")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StatusId,StatusName,StatusNotes,StatusDisabled,TableName")] Status status)
        {
